...
module.exports.owners_get = function(req, res, next) {
...
module.exports.owner_create = function(req, res, next) {
...
module.exports.owner_getOne = function (req, res, next) {
...
module.exports.owner_update = function(req, res, next) {
...
module.exports.owner_delete = function(req, res, next) {
